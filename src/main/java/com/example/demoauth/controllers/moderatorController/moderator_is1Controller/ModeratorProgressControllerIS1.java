...
public class ModeratorProgressControllerIS1 {
    ...
    //GetMappingProgress
    @GetMapping("/moderator_is_1_1/{course}/progressIS11")
    ...
    //PostMappingProgress
    @PostMapping("/moderator_is_1_1/{course}/progressIS11")
